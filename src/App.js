...
// const inputWord = (string) => { 
  if(currentWord[0] !== currentWord.search(/[aeiou]/g)) {
    return (currentWord.charAt(1) + currentWord.substring(2) + currentWord[0] + "ay")
  } else if(currentWord[0] === currentWord.search(/[aeiou]/g)) {
    return (currentWord + "way")
  } else if(currentWord.slice(0,2) === "qu") {
    return (currentWord.slice(2) + currentWord.slice(0,2) + "ay") 
  // } else if(currentWord(1,2) === currentWord.search(/[y]/g)) {
  //   return (currentWord.charAt[1, 2] + currentWord.substring(2) + "way")
  } else {
